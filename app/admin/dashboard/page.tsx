...
export default async function DashboardPage() {
    ...
    // Calculate Conversion Rate (Appointments / Total Leads)
    const conversionRate = leadCount && leadCount > 0
        ? ((appointmentCount || 0) / leadCount * 100).toFixed(1)
        : "0";
        ...
        <div className="min-h-screen bg-zinc-950 text-white p-8">
            <div className="max-w-7xl mx-auto space-y-8">
                ...
                <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
                    <KpiCard label="Total Leads" value={leadCount || 0} />
                    <KpiCard label="Active Conversations" value={activeLeads || 0} />
                    <KpiCard label="Appointments" value={appointmentCount || 0} />
